...
En_trans_PSD(:,cy_count)=(En(:,detec_trans_position));  %%% detection at floor(slab2_RHS_gap/2) from the RHS boundary 
%---------------------- Record the reflection for 1 beat period ---------
En_refl_PSD(:,cy_count)=(En(:,detec_refl_position));  %%% detection at 1 cell after the LHS boundary 
%--------------------------------------------------------------------------
end
