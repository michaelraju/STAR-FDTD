...
dz=init_data.dz;
%----------------------------------
src_y=floor(Ny/2)-floor(100/(kref*dz));    % Centering the source along Y axis
beam_width=floor(Ny/10);  % size of the incident beam 
...
E0src=1;                                 % amplitude of the source function
...
dipole_source = ...
 @(t_count,wave_amp,wave_phase,t_sign,fsrc) (slowly_rise(t_count).*wave_amp.*cos(t_sign*2*pi*fsrc*(t_count-1)*dt + ...
