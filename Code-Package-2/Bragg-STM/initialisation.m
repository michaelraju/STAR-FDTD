...
macropixel_size=10; % Particle macro pixel size in terms of no of grid 
...
start_slab1=floor((Nz/3)-(scat_width/2)); 
...
colormap jet
imagesc([0 kref*dz*(Nz-1)],[0 kref*dy*(Ny-1)],sqrt(epsilon_ij));  % Refractive index = sqrt(dielectric constant)
