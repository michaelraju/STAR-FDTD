...
fsrc_SB=fsrc+nth*f_mod;  % nth modulated order frequency
...
hIm=imagesc([0 kref*dz*(Nz-1)],[0 kref*dy*(Ny-1)],En(2:end-1,2:end-1));axis xy equal tight;
...
line([STM_start_z*kref*dz (STM_start_z+grat_width-1)*kref*dz ...
    ...
    STM_start_z*kref*dz ],[STM_start_y*kref*dy ...
    STM_start_y*kref*dy STM_end_y*kref*dy  STM_end_y*kref*dy ...
    STM_start_y*kref*dy])
hold on
...
En_trans_PSD(:,cy_count)=(En(:,detec_trans_position));  
  %%% transmission detection at detec_trans_position 
