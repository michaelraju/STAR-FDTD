function [Efield_array_collection] = FDTD_main_loop_STM(GPU_flag,visualisation_flag,...
...
line([STM_start_z*kref*dz (STM_start_z+grat_width-1)*kref*dz ...
    ...
    STM_start_z*kref*dz ],[STM_start_y*kref*dy STM_start_y*kref*dy STM_end_y*kref*dy ...
